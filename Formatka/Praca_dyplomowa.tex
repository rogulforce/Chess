...
Pierwszym problemem, który zostanie poruszony jest zbadanie statystycznej zależności jakości wykonanego ruchu wg oceny silnika Stockfish od czasu potrzebnego na jego wykonanie.
...
np dla formatu 300+0 (300 sekund, brak dodawanego czasu po wykonaniu ruchu)

\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{sample_300.png}
...
tj, w formacie czasowym 60+0 na ruch zostały poświęcone 4 sekundy, jaka jest szansa, że został popełniony błąd \newline
