...
wyciągnięcie danych które posiadają ocenę silnika

dla każdej gry, dla każdego ruchu:
> znalezienie oceny silnika
> ustalenie czasu poświęconego na wykonanie ruchu

stworzenie bazy danych (póki co pracuje na części danych, bo obliczenia są wygodniejsze):
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{danee.png}
	\caption{xxxs}\label{xxxs}
\end{figure}
