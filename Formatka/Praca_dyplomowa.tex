...
\tytul{Analiza statystyczna czasów na wykonywanie ruchów w
	szachach} 
\tytulang{Statistical analysis of times between chess moves}
%
...
\streszczenieang{The paper presents an analysis of the relationship between the times of taking individual chess moves, their number and quality, taking as a measure compliance with the chess engine. Statistical analysis will be performed with particular emphasis on the differences resulting from the ranking level of players and the time format of individual games.}
%
