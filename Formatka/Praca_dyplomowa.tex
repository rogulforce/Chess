...
Główna część pracy składać się będzie z trzech części. W pierwszej z nich odnaleźć będzie można dokładne sformułowanie problemów, które są przedmiotem badań niniejszej pracy. Następnie uwidocznione zostaną dane, na których bazuje późniejsza analiza.  \textbf{COŚ O DANYCH JESZCZE}
...
\textbf{\textbf{krótko na czym polegają szachy i cite gdzie można znaleźć pełne przepisy,isbn:002028540X}\\}
...
Stockfish poprzez przeszukiwanie według strategii mini-max \textbf{[cite: E. Vilkas, "Axiomatic definition of the value of a matrix game" Theory Probabl. Appl. , 8 (1963) pp. 304–307 Teor. Veroyatnost. i Primenen. , 8 : 3 (1963) pp. 324–327 MR0154750 Zbl 0279.90044]} z odcięciem, za pomocą algorytmu alfa-beta \textbf{[cite]}, analizuje legalne (czyli następujące po ruchu zgodnym z zasadami gry) pozycje, które mogą wyniknąć z aktualnej sytuacji na szachownicy. Dobierają na podstawie najlepszego możliwego zestawu ruchów (zakłada się, że każdy z graczy wykona najlepszy w ocenie silnika ruch) pozycje, które wystąpią dla określonej głębokości (głębokość 18 oznacza 18 ruchów białych i 18 czarnych wykonanych zaczynając z analizowanej pozycji) i na ich podstawie ocenia aktualną pozycję, określając przewagę jednego z graczy
